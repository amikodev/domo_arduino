...
#define MIFARE_CMD_ULTRALIGHT_WRITE         (0xA2)
...
public:
    ...
    u8 InListPassiveTarget(u8 *uid, u8 *uidLength, u8 brty=PN532_BRTY_ISO14443A, u8 maxtg=1, u8 *idata=NULL);
    ...
    u8 MifareReadPage(u8 page, u8 *buffer);
    u8 MifareWritePage(u8 page, u8 *buffer);
